...
from data.loaders import RosbagDataset
...
dataset_train = RosbagDataset('real_imgs', '/camera/depth/image_rect_raw', transform=transform_train, train=True)
dataset_test  = RosbagDataset('real_imgs', '/camera/depth/image_rect_raw', transform=transform_test, train=False)
